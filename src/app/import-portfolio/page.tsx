        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="text-sm text-blue-800">Bank Accounts</div>
              <div className="text-xs text-blue-600">₹1.37 Crores</div>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-green-600">13</div>
              <div className="text-sm text-green-800">Fixed Deposits</div>
              <div className="text-xs text-green-600">₹15 Lakhs</div>
            </div>
            <div className="bg-yellow-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-yellow-600">1</div>
              <div className="text-sm text-yellow-800">Gold Investment</div>
              <div className="text-xs text-yellow-600">450g @ ₹6000/g</div>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-purple-600">10</div>
              <div className="text-sm text-purple-800">Recent Transactions</div>
              <div className="text-xs text-purple-600">Income & Expenses</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          {importMode === 'demo' ? (
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">Demo Portfolio Data</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                <h3 className="font-semibold text-green-900 mb-2">📋 Step 1: Download Template</h3>
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                <h3 className="font-semibold text-purple-900 mb-2">📤 Step 2: Upload Your Data</h3>
        ...
        {validationErrors.length > 0 && (
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-8">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-orange-800">Data Validation Errors</h3>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              <div className="bg-white p-3 rounded border">
                <div className="text-xl font-bold text-blue-600">{results.accounts}</div>
                <div className="text-sm text-gray-600">Accounts Imported</div>
              </div>
              <div className="bg-white p-3 rounded border">
                <div className="text-xl font-bold text-green-600">{results.fixedDeposits}</div>
                <div className="text-sm text-gray-600">Fixed Deposits</div>
              </div>
              <div className="bg-white p-3 rounded border">
                <div className="text-xl font-bold text-yellow-600">{results.goldInvestments}</div>
                <div className="text-sm text-gray-600">Gold Investments</div>
              </div>
              <div className="bg-white p-3 rounded border">
                <div className="text-xl font-bold text-purple-600">{results.transactions}</div>
      ...
      "accountName": "Account Name"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-blue-50 rounded-lg p-3">
                  <h4 className="font-medium text-blue-900 text-sm">✅ Data Validation</h4>
                ...
                <div className="bg-green-50 rounded-lg p-3">
                  <h4 className="font-medium text-green-900 text-sm">💡 Pro Tips</h4>

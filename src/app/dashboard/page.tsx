      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white rounded-lg shadow-lg p-6">
            ...
            <p className="text-yellow-100 text-sm">₹{totalGoldValue.toFixed(2)} value</p>
          </div>
        </div>
            ...
            <div className="p-6 space-y-4">
              <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-blue-600">₹{totalFDInvestment.toFixed(2)}</p>
              ...
              <div className="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-yellow-600">₹{totalGoldValue.toFixed(2)}</p>
              ...
              <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-purple-600">₹{totalAccountBalance.toFixed(2)}</p>
